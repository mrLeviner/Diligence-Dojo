...
var body = document.body.classList.add("color");
...
class Audio {
    ...
    _render() {
        var maxNum = 255, frequencyAvg = 0, num, mult, spectrum, indexPos;
...
//     }.bind(this), false);
    ...
    detectIndex() {
        ...
        for (var i = 0; i < this.verticesArray.length; i+= 3) {
            var vec3 = {};
